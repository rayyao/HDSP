...
def main():
    ...
    parser.add_argument('--script', type=str, default='', required=True, help='Name of the train script.')
    parser.add_argument('--config', type=str,default='', required=True, help="Name of the config file.")
