...
import torch
import traceback
from viptnew.lib.train.admin import multigpu
...
class BaseTrainer:
    ...
    def __init__(self, actor, loaders, optimizer, settings, lr_scheduler=None):
        ...
        if self.device is None:
            self.device = torch.device("cuda:{[0,1,2]}" if torch.cuda.is_available() and settings.use_gpu else "cpu")
    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        if checkpoint is None:
            ...
            if checkpoint_list:
                ...
                print('No matching checkpoint file found ,load pretrain')
                return

         #checkpoint_path = '/home/zl/newvipt/viptnew/pretrained/OSTrack_ep0100.pth.tar'
        ...
        # Load network
        #checkpoint_path = '/home/zl/AbandTwovipt/viptnew/pretrained/OSTrack_ep0300.pth.tar'
