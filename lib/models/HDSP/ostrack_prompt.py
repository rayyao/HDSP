...
from lib.models.HDSP.HDSP_deep import vit_base_patch16_224_ce_prompt
from lib.utils.box_ops import box_xyxy_to_cxcywh
class HDSPtrack(nn.Module):
...
def build_hdsptrack(cfg, training=True):
    ...
    #prompt_fusion=build_prompt_fusion()
    ...
    if 'OSTrack' in cfg.MODEL.PRETRAIN_FILE and training:
        ...
        #missing_keys, unexpected_keys = model.load_state_dict(checkpoint["net"])
